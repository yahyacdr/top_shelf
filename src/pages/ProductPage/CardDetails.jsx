...
const CardDetails = memo(() => {
  ...
  const { price, discount, quantity, weight, additions, dispatch } = useCart();
  ...
  console.log(
    ...
    discount,
    additions.price,
    price * weight.price * quantity - discount + additions.price
  );
  return (
    <PostContext.Provider values={{ reviewsNum, currentCard }}>
