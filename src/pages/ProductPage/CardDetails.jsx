    ...
    <StyledCardDetails>
      ...
      <Qualities>
        ...
        <Quality>
          ...
          <p className="🍥">
            Anxiety, Arthritis, Chronic Pain, Depression, Fatigue, Inflamation,
            Insomnia, Irregular Bowel Movements, Migraines, Mood Swings
          </p>
        </Quality>
        <Quality>
          <svg
      ...
      <Add>
        ...
        <Filter.Check label="4g (+$2.00)" />
        <Filter.Check label="8g (+$3.00)" />
      </Add>
      <OfferPill>
      ...
      <PurchaseBox>
        <PurchasedItem>
          <p>
            Khalifa Kush (AAAA)<span>2x</span>
          </p>
        ...
        <AddToCart>
          ...
          <Btn shape="pill" variation="primary" size="medium">
            <p>Add to Cart</p>|<span>{formatCurrency(242)}</span>
          </Btn>
        </AddToCart>
